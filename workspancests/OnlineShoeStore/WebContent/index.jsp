...
<div class="jumbotron">
			...
			<div id="header-container" class="container navbar-container">
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> My Account</a>
							<ul class="dropdown-menu">
								<li><a href="showLoginForm">My Profile</a></li>
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="G:\carousel1.jpg" alt="Jordans">
				<div class="carousel-caption"></div>
			</div>

			<div class="item">
				<img src="G:\carousel2.jpg" alt="Vans">
				<div class="carousel-caption"></div>
			</div>

			<div class="item">
				<img src="G:\carousel3.jpg" alt="Converse">
				<div class="carousel-caption"></div>
			</div>
		</div>
	...
	<div id="CustomerSupport" text-align="center">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-12">
					<h1 class="h1">
						Contact us! <small><i>Feel free to contact us</i></small>
					</h1>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<form>
					...
					<address>
						<strong>HCL United Inc.</strong><br> SY No.1/1, Plot No
						42-49, Hardware Park,<br> Road No. 2, Kancha Imarat,
						<br> Hyderabad, Telangana<br> <abbr
							title="Phone"> P:</abbr> (040) 7941 0555
					</address>
					<address>
						<strong>Mail Us!</strong><br> <a href="mailto:#">www.hcltalentcare.com</a>
					</address>
				</form>
			</div>
		</div>
	...
	<footer class="container-fluid">
		...
		<form class="form-inline text‐center">
			Subscribe for newsletter /Get deals: <input type="email"
				class="form-control" size="50" placeholder="Email Address">
