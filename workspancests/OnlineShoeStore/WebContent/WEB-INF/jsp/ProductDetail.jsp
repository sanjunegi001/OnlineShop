		...
		<div id="header-container" class="container navbar-container">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="active"><a href="ProductDetail/showUpdate">Home</a></li>
...
<tr >
<td rowspan="1">
<img src="${productTO.productPicture}" width="50%"/>
</td>
</tr>
<tr align="center">
<td><font>${productTO.productBrand}</font></td>
</tr>
<tr align="center">
<td><font>Rs. ${productTO.productPrice}</font></td>
</tr>
<tr align="center">
<td><font>${productTO.productDescription}</font></td>
</tr>
<tr>
<td><input type="submit" value="ADD to CART"></td>
<td align="left"><input type="submit" value="BUY"></td>
</tr>
</table>
</div>
