...
public class BFDDataFromDeviceToAUA {
	...
	public BFDDataFromDeviceToAUA(String uid, String terminalId, SessionKeyDetails sessionKeyDetails, byte[] encryptedRbd, byte[] encrytpedHmac, String certificateIdentifier, DataType dataType, Meta meta) {
		this.uid = uid;
