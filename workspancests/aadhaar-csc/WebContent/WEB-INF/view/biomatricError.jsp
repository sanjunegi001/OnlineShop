                       ...
                       <td style="margin-top: 24px;margin-left: 19px;float: left;">
                          <table>
                                <tr>
                                   ...
                                   <td><span style="color: #797272;font-weight: bold;font-size: 14px;padding-left:2px;"><c:out value="${biotransactionnm}"/></span></td>
                                </tr>
                             
                                <tr>
                                   <td><span style="font-weight:bold ;font-size: 16px;">Errorcode:</span></td>
                                    <td><span style="color: red;font-weight: bold;font-size: 14px;"><c:out value="${ErrorCode}"/></span></td>
                                </tr>
